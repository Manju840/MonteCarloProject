...
public class WebDriverUtilities {
	...
	public WebElement waitForElementToRefreshed(WebElement ele) {
		return wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(ele)));
	}

	public WebElement waitForElementToRefreshedVisible(WebElement ele) {
		return wait.until(ExpectedConditions.refreshed(ExpectedConditions.visibilityOf(ele)));
	}
